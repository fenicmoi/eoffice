...
<div class="row">
    ...
    <div class="col-md-10">
        <div class="panel panel-primary">
            <div class="panel-heading"><i class="fas fa-shopping-cart fa-2x"></i> <strong>ทะเบียนคุมสัญญาซื้อ/ขาย
                </strong>
                    ...
                    <form method="post" id="frmMain" name="frmMain" acton="">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="ระบุเรื่อง"
                                    required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="money_project" name="money_project"
                                    required="" value="0">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="dep_name" name="dep_name" value="<?php
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="governer" name="governer"
                                    value="ผู้ว่าราชการจังหวัดพัทลุง">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="company" name="company"
                                    placeholder="ชื่อร้าน/บริษัท" required="">
                        ...
                        <div class="form-group">
                            <div class="input-group col-xs-6">
                                <span class="input-group-addon"><label for="date_stop">วันที่ครบกำหนด(งวดสุดท้าย)
                                        :</label></span>
                                <input class="form-control" type="date" name="date_stop" id="date_stop"
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-addon"><label
                                        for="selConFirm">ประเภทหลักประกันสัญญา</label></span>
                                ...
                                <input type="text" class="form-control" id="txtMoney" name="txtMoney" required=""
                                    value="0">
                            </div>
                        </div>
                        <div id="bank">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="date" name="date_num" id="date_num"
                        ...
                        <center>
                            ...
                            <button class="btn btn-success btn-lg" type="submit" name="btnsave" id="btnsave">
                                <div class="col-sm-5"><?php echo csrf_field(); ?></div><i class="fa fa-save fa-2x"></i>
                                SAVE
                            </button>
                        </center>
                    </form>
...
if (isset($_POST['btnsave'])) {
    ...
    //running number
    $yid = $_SESSION['yid'];
    $sql = "SELECT MAX(rec_no) as max_id FROM buy WHERE yid = ?";
    $query = dbQuery($sql, "i", [$yid]);
    $rs = dbFetchArray($query);
    $rec_no = $rs['max_id'] + 1;

    dbQuery('BEGIN');

    if (verify_csrf_token($_POST['csrf_token'] ?? '')) {
        $sql = "INSERT INTO buy (rec_no, dep_id, sec_id, yid, u_id, governer, title, company, manager, add1, signer, add2, telphone, product, location, date_submit, date_stop, money, money_project, bank, brance, doc_num, date_num, confirm_id) 
                                  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $params = [
            $rec_no,
            $dep_id,
        ...
        $types = "iiiiisssssssssssddsssssi";
        $result = dbQuery($sql, $types, $params);
        if ($result) {
            echo "<script>swal({title:'บันทึกข้อมูลเรียบร้อย', type:'success'}, function(){ window.location.href='buy.php'; });</script>";
        } else {
            echo "<script>swal({title:'มีบางอย่างผิดพลาด!', type:'error'});</script>";
        }
    }
