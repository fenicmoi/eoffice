                ...
                <div class="col-md-3">
                    <div class="panel panel-default"
                        ...
                        <div class="panel-heading"
                            style="background: linear-gradient(135deg, #5a5c69, #373840); color: white; border-radius: 8px;">
                            <i class="fas fa-building fa-3x pull-left" style="opacity: 0.8;"></i>
                            <div class="text-right">
                                <div class="huge" style="font-size: 30px; font-weight: bold;">
                            ...
                            <div style="font-size: 12px; margin-top: 5px; text-align: right; opacity: 0.9;">
                                <i class="fas fa-search-plus"></i> คลิกเพื่อดูรายละเอียด
                            </div>
                        </div>
                    </div>
                </div>
