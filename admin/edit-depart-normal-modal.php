...
$sqlFlowNormal = "SELECT * FROM flownormal_depart WHERE cid=?";
$resSqlFlowNormal = dbQuery($sqlFlowNormal, "i", [(int) $cid]);
$rowFlowNormal = dbFetchAssoc($resSqlFlowNormal);
...
$speed = $rowFlowNormal['speed_id'];
$sec_id = $rowFlowNormal['sec_id'];
$obj_id = $rowFlowNormal['obj_id'];
$sendFrom = $rowFlowNormal['sendfrom'];
$sendTo = $rowFlowNormal['sendto'];
$title = $rowFlowNormal['title'];
$refer = $rowFlowNormal['refer'];
$attachment = $rowFlowNormal['attachment'];
$prefex = $rowFlowNormal['prefex'];
$rec_no = $rowFlowNormal['rec_no'];
$practice = $rowFlowNormal['practice'];
$file_location = $rowFlowNormal['file_location'];
$dateout = $rowFlowNormal['dateout'];
...
$yname = $data[1];
?>
<form name="formEdit" method="post" action="normaloffice.php" enctype="multipart/form-data">
    ...
    <table width="100%" class="table table-bordered">
        <tr>
            <td>
                ...
                <div>
                    <input name="typeDoc" type="radio" value="0" checked=""> ปกติ
                    <input name="typeDoc" type="radio" value="1" disabled> เวียน
                </div>
            </td>
            <td>
        ...
        <tr>
            <td>
                ...
                <input type="text" class="form-control" name="prefex" id="prefex"
                    value="<?php print $prefex; ?>/<?php print $rec_no; ?>" disabled>
            </td>
            <td>
