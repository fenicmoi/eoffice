                ...
                <div class="panel-heading">
                 ...
                 <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                                if($level_id < 3){
                                    $sql="SELECT * FROM  flowdepart ORDER BY cid DESC";
                                }else{
                              ...
                              // print $level_id;
                                ...
                                while($row = dbFetchArray($result)){?>
                                    ...
                                    <td>
                                                ...
                                                if($date_diff <= 10){?>
                                                    <a class="btn btn-success" href="flow-depart-edit.php?u_id=<?=$u_id?>&cid=<?=$cid?>"><i  class="fas fa-edit"></i></a>
                    ...
                    <div class="panel-footer">
							<center>
								<a href="flow-depart.php" class="btn btn-primary"><i class="fas fa-home"></i> หน้าหลัก</a>
								<?php 
              ...
              <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                  <div class="modal-header bg-primary">
                    ...
                    <h4 class="modal-title"><i class="fa fa-plus-circle"></i> ลงทะเบียนหนังสือส่ง</h4>
                  </div>
