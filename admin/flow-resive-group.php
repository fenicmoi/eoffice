...
<div class="col-md-10">
	<div class="panel panel-primary">
		<div class="panel-heading"><i class="fa fa-university fa-2x"></i> <strong>หนังสือรับกลุ่มงาน</strong>
			<div class="btn-group btn-grouop-lg pull-right">
				...
				<a href="statis-flow-resive-group.php" class="btn btn-default"><i
						class="fas fa-chart-pie"></i>สถิติข้อมูล</a>
			...
			while ($row = dbFetchArray($result)) { ?>
				<tr>
					...
					<td>
						<?php if ($numday > 3) { ?>
							<a class="text-success" href="#"
								onClick="load_leave_data('<?php print $cid; ?>','<?php print $u_id; ?>');" data-toggle="modal"
					...
					<td>
						<?php
						if ($row['status'] == 0) { ?>
							<a class="btn btn-danger btn-block" href="?close=<?php echo $row['cid']; ?>"><i
									class="far fa-question-circle"></i></a>
						<?php } else { ?>
							<a class="btn btn-warning btn-block" href="?open=<?php echo $row['cid']; ?>"><i
	...
	<div class="panel-footer">
		<center><kbd>1.คลิกปุ่มเพื่อเปลี่ยนสถานะ</kbd> ::<i class="far fa-question-circle"></i>=อยู่ระหว่างดำเนินการ::<i
				class="far fa-thumbs-up"></i>=ดำเนินการเสร็จแล้ว</center>
	</div>
	<!-- class panel -->
					...
					<form name="form" method="post" enctype="multipart/form-data">
						<div class="form-group col-md-6">
							<div class="input-group">
								...
								<input class="form-control" name="yearDoc" type="text" value="<?php print $yname; ?>"
									disabled="">
							</div>
						</div>
						...
						<div class="form-group col-md-6">
							<div class="input-group">
								...
								<input class="form-control" type="text" name="book_no" id="book_no"
									placeholder="เลขที่หนังสือ" required>
							</div>
						</div>
						<div class="form-group col-md-4">
							<div class="input-group">
						...
						<div class="form-group col-md-8">
							<div class="input-group">
								...
								<input class="form-control" type="text" name="sendfrom" id="sendto"
						...
						<div class="form-group col-md-8">
							<div class="input-group">
								...
								<input class="form-control" type="text" name="owner" id="owner"
									placeholder="ส่วนราชการเจ้าของเรื่อง" required>
							</div>
						</div>
						...
						<div class="col-md-12">
							<center>
								<button class="btn btn-success" type="submit" name="save"><i class="fas fa-save"></i>
									บันทึก
		...
		<div class="modal-content ">
			...
			<div class="modal-body">
				<form class="form-inline" role="form" id="form_other" name="form_other" method="POST"
					action="report/rep-resive-group.php" target="_blank">
					<center>
						<div class="form-group">
							<div class="input-group">
...
<div id="myReport1" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content ">
			...
			<div class="modal-body">
				<form class="form-inline" role="form" id="form_other" name="form_other" method="POST"
					action="report/rep-resive-group-mount.php" target="_blank">
					<center>
						<div class="form-group">
							<div class="input-group">
...
if (isset($_POST['update'])) { //กดปุ่มบันทึกจากฟอร์มบันทึก
	...
	$sql = "UPDATE flow_recive_group 
			...
			WHERE cid=? ";
	$result = dbQuery($sql, "ssssssi", [$title, $sendfrom, $sendto, $dateout, $datein, $practice, $cid]);
...
if (isset($_POST['save'])) { //กดปุ่มบันทึกจากฟอร์มบันทึก
	...
	$sql = "SELECT rec_no FROM flow_recive_group WHERE dep_id=? and sec_id=?  and yid=?  ORDER  BY cid DESC";
	//echo $sql;
	$result = dbQuery($sql, "iii", [$dep_id, $sec_id, $yid]);
	...
	$result = dbQuery($sql, "issssssssiiii", [$rec_no, $book_no, $title, $owner, $sendfrom, $sendto, $practice, $dateout, $datein, $dep_id, $sec_id, $u_id, $yid]);
