<footer class="footer bg-dark text-white">
  <div class="container">
    <p class="text-muted">
      ...
      พัฒนาโดย:กลุ่มงานยุทธศาสตร์และข้อมูลเพื่อการพัฒนาจังหวัด <i class="fas fa-user"></i> <i class="fas fa-fax"></i>
      074-613409
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-body">
        <div class="card">
          <img class="img-rounded" src="../images/infinity.jpg" alt="somsak" style="width:30%">
          ...
          <p><i class="fas fa-mobile-alt"></i>: 0-8153-99135</p>
