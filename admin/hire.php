...
<!--เพิ่มข้อมูล -->
<div id="modalAdd" class="modal fade" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="dep_id" name="dep_id"
                                value="<?php echo htmlspecialchars($row['dep_name']); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                    ...
                    <div class="form-group form-inline">
                        <div class="input-group">
                            ...
                            <input class="form-control" type="date" name="datehire" id="datehire"
                    ...
                    <div class="form-group form-inline">
                        <div class="input-group">
                            ...
                            <input class="form-control" type="date" name="date_submit" id="date_submit"
                                onKeyDown="return false" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="signer" name="signer" placeholder="ผู้ลงนาม"
                                value="ผู้ว่าราชการจังหวัด" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon">หลักประกันสัญญา</i></span>
                            <input type="number" class="form-control" id="guarantee" name="guarantee" value="0"
                                required="" ;>
                        </div>
                    </div>
                    <center>
...
<!--เพิ่มข้อมูล -->
<div id="modalEdit" class="modal fade" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
...
if (isset($_POST['save'])) {
    ...
    //ตัวเลขรันอัตโนมัติ
    $sql = "SELECT MAX(rec_no) AS rec_no FROM hire WHERE yid = ? ORDER BY hire_id DESC LIMIT 1";
    ...
    $result = dbQuery($sql, "isssissisiiii", [
        (int) $rec_no,
        $datein,
        $title,
        $money,
