    ...
    if ($row) {
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <i class="fa fa-edit"></i> แก้ไขข้อมูลสัญญาซื้อ/ขายเลขที่:
                **<?php echo htmlspecialchars($row['rec_no'] ?? '') . '/' . htmlspecialchars($row['yname'] ?? ''); ?>**
            </div>
            <div class="panel-body">
                <form method="post" action="buy-update.php">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="buy_id" value="<?php echo (int) $buy_id; ?>">
                    <input type="hidden" name="rec_no" value="<?php echo htmlspecialchars($row['rec_no'] ?? ''); ?>">
                    <input type="hidden" name="yname" value="<?php echo htmlspecialchars($row['yname'] ?? ''); ?>">

                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon">ผู้ว่าจ้าง/ผู้มีอำนาจ</span>
                            <input type="text" class="form-control" id="governer_edit" name="governer"
                                value="<?php echo htmlspecialchars($row['governer'] ?? ''); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="company_edit" name="company"
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="manager_edit" name="manager"
                                value="<?php echo htmlspecialchars($row['manager'] ?? ''); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="add1_edit" name="add1"
                                value="<?php echo htmlspecialchars($row['add1'] ?? ''); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="add2_edit" name="add2"
                                value="<?php echo htmlspecialchars($row['add2'] ?? ''); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="telphone_edit" name="telphone"
                                value="<?php echo htmlspecialchars($row['telphone'] ?? ''); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="product_edit" name="product"
                                value="<?php echo htmlspecialchars($row['product'] ?? ''); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control" id="date_submit_edit" name="date_submit"
                                value="<?php echo htmlspecialchars($row['date_submit'] ?? ''); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control" id="date_stop_edit" name="date_stop"
                                value="<?php echo htmlspecialchars($row['date_stop'] ?? ''); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="money_edit" name="money"
                                value="<?php echo htmlspecialchars($row['money'] ?? '0'); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="money_project_edit" name="money_project"
                                value="<?php echo htmlspecialchars($row['money_project'] ?? '0'); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="bank_edit" name="bank"
                                value="<?php echo htmlspecialchars($row['bank'] ?? ''); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="brance_edit" name="brance"
                                value="<?php echo htmlspecialchars($row['brance'] ?? ''); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="doc_num_edit" name="doc_num"
                                value="<?php echo htmlspecialchars($row['doc_num'] ?? ''); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control" id="date_num_edit" name="date_num"
                                value="<?php echo htmlspecialchars($row['date_num'] ?? ''); ?>">
                        </div>
                    </div>
