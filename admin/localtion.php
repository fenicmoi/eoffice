<?php
// ไฟล์สำหรับทำ  dropdown
header("content-type: text/html; charset=utf-8");
header("Expires: Wed, 21 Aug 2080 13:13:13 GMT");
...
if ($data == 'province') {
     ...
     echo "<select id=\"state\" class=\"form-control selectpicker\" data-live-search=\"true\" name='amphur' onChange=\"dochange('district', this.value)\" required>";
     echo "<option value=''>- เลือก -</option>\n";
