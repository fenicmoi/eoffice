...
$sql = "SELECT u.puid, u.pid,p.postdate,p.title,p.file,d.dep_name,s.sec_name,us.firstname FROM paperuser u
      ...
      WHERE u.u_id=" . (int) $u_id . " AND u.confirm=0 ORDER BY u.puid";
//print $sql;
...
<div class="col-md-10">
	<div class="panel panel-primary">
		<div class="panel-heading"><i class="fas fa-share-square"></i> <strong>ส่งไฟล์เอกสาร
				:ส่งไฟล์เอกสารภายในจังหวัด</strong></div>
						...
						<tr>
							...
							<?php } else { ?>
								<td><a class="btn btn-success"
										href="recive.php?pid=<?php echo $rowNew['pid']; ?>&sec_id=<?php echo $sec_id; ?>&dep_id=<?php echo $dep_id; ?>"><i
											class="fas fa-check"></i> ลงรับ</a></td>
							<?php } ?>
