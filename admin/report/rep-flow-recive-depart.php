...
$dep_id = $_SESSION['ses_dep_id'];      // รหัสกรม
$sec_id = $_SESSION['ses_sec_id'];      // รหัสหน่วยงาน
$dateprint = $_POST['dateprint'];       // วันที่พิมพ์รายงาน
$haftday = $_POST['rep_time'];          // เช้า บ่าย


$uid = $_POST['uid'];     // รหัสผู้ใช้
$yid = $_POST['yid'];
...
<body>
    ...
    <table cellspacing="0" cellpadding="1" border="1" style="width:1100px;">
        ...
        if ($haftday == 1) {
            $sql .= " AND f.time_stamp <= '12:00:00' ";
        } elseif ($haftday == 2) {
            $sql .= " AND f.time_stamp > '12:00:00' ";
        }

        $sql .= " ORDER BY f.cid DESC";
        ...
        <tr>
            <td colspan="10">
                <center><b>รวมหนังสือรับ</b></center>
            </td>
            <td>
