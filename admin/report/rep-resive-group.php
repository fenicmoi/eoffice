...
<head>
    ...
    <title>พิมพ์รายงานหนังสือรับประจำวัน[กลุ่มงาน]</title>
    ...
    <table cellspacing="0" cellpadding="1" border="0" style="width:100%;">
        <tr>
            <td class="header-bg" colspan="8">
                <center>
                    <h4>รายงานทะเบียนรับหนังสือ[กลุ่มงาน] ประจำวันที่ <?= thaiDate($dateprint) ?></h4>
                </center>
            </td>
        </tr>
        <tr>
...
$mpdf->Output('รายงานหนังสือรับกลุ่มงาน_' . date('Ymd') . '.pdf', \Mpdf\Output\Destination::INLINE);
