...
<table border=1 width=100% class="table table-hover">
    <tr>
        ...
        <td><?php echo htmlspecialchars($row['prefex']); ?>/ว<?php echo htmlspecialchars($row['rec_no']); ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><?php echo htmlspecialchars($row['obj_name']); ?></td>
    </tr>
    <tr>
        <td><label>ผู้ส่ง:</label></td>
        <td><?php echo htmlspecialchars($row['sendfrom']); ?></td>
    </tr>
    <tr>
        <td><label>ผู้รับ:</label></td>
        <td><?php echo htmlspecialchars($row['sendto']); ?></td>
    </tr>
    <tr>
        <td><label>อ้างถึง:</label></td>
        <td><?php echo htmlspecialchars($row['refer']); ?></td>
    </tr>
    <tr>
        <td><label>สิ่งที่ส่งมาด้วย:</label></td>
        <td><?php echo htmlspecialchars($row['attachment']); ?></td>
    </tr>
    <tr>
