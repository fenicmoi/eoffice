...
<body>
<table width="100%" border="5" cellspacing="0" cellpadding="0" bordercolor="#000000">  
  <tr>
        ...
        <td width="85%" valign="top" bgcolor="#E5E5E5"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><div align="center" class="title">:: ข้อมูลการใช้ห้องประชุมประจำวันที่ <? echo $today; ?> :: </div></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
